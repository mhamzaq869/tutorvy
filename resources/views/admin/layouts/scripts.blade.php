                    ...
                    if(obj.length == 0){
                        ...
                        for(var i =0; i < obj.length; i++) {
                            ...
                            if(obj[i].sender_pic != null){
                                img = `<img class="profile-img w-100 p-0" src="{{asset('`+obj[i].sender_pic+`')}}" alt="layer">`;
                            }
                            else{
                                img = `<img class="profile-img w-100 p-0" src="{{asset('assets/images/ico/Square-white.jpg') }}" alt="layer">`;
                            }
                        notification +=`
                        <li >
                            <a href="`+obj[i].slug+`">
