                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li rel-index="2" class="bordr-none">
                                        <a href="#step-3" class=" disabled" aria-controls="step-3" role="tab"
                                            data-toggle="tab">
                                            <span>
                                                <img class="mb-3" src="../assets/images/ico/cap-icon.png" alt="cap-icon">
                                            </span>
                                        </a>
                            ...
                            <div class="tab-content mt-5">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row mt-5">
                                            <div class="input-text col-md-6">
                                                <input type="" class="form-control csd" placeholder="First Name">
                                        ...
                                        <div class="row mt-3">
                                            <div class="input-text col-md-6">
                                                <div class="autocomplete mt-1" style="width:300px;">
                                                    <input id="myInput" type="" name="myCountry" placeholder="City">
                                                </div>
                                            </div>
                                            <div class="input-text col-md-6">
                                            ...
                                            <div class="container mt-3">
                                                <div class=" row">
                                                    ...
                                                    <div class="input-text col-md-6">
                                                        <input id="textbox" type="number" class="form-control"
                                    ...
                                    <div class="col-md-12 ">
                                        ...
                                        <div class=" customer_records mt-5">
                                            ...
                                            <div class="button-wrapper mt-4">
                                                <span class="label ">
                                                    <img src="../assets/images/ico/attach.png" class="w-25 " alt="i">
                                                    Attach
                                                    degrees
                                                </span>
                                        ...
                                        <a class="extra-fields-customer" href="#"
                                            style="font-size: 16px;font-family: Poppins;text-decoration: none;">+ Add
                                            more degrees </a>
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    ...
                                                    <div class="element">
                                                        ...
                                                        <div class="row">
                                                            <div class="input-text col-md-6">
                                                                <select class="form-select form-select-lg mb-4 mt-4"
                                                                    aria-label=".form-select-lg example">
                                ...
                                <div role="tabpanel" class="tab-pane border-right" id="step-4"
                                    ...
                                    <div class="col-8" style="float: right;">
                                        <a href="../Login/skip.html"> <button id="step-1-next"
