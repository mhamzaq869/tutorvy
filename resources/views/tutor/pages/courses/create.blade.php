                    ...
                    <div class="container-fluid mt-3">
                        ...
                        <div class=" mt-5">
                            ...
                            <div class="input-serachs mt-2">
                                <input type="search" name="course_title"
                                    placeholder="How to create your online courses in 3 steps." />
                            </div>
                            <div class="mt-3">
                    ...
                    <div class="mt-5"><br />
                        ...
                        <div class="bg-edit mt-4 text-center">
                            ...
                            <input type="file" class="dropify" name="thumbnail" id="thumbnail"
                                data-default-file="https://www.youtube.com/watch?v=bUZZvsuRHHY">
            ...
            <div class="container-fluid mt-3 pb-5">
                <div class="row">
                    ...
                    <div class="col-md-4 border-right mb-1">
                        ...
                        <div class="input-options mt-2">
                            <select name="advance_days" id="adv_duration">
                                <option disabled selected>Select days</option>
                        ...
                        <div class="input-options mt-2">
                            <input type="text" class="form-control" placeholder="Add course price">
                        </div>
                        <!-- <div class="text-center mt-4">
                            <input type="submit" class="schedule-btn w-50 " value="Submit course" />
                        </div> -->
