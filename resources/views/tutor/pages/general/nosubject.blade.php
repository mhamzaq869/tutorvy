  ...
  <div class="container" style="margin-bottom: 50px">
      <div class="row">
          <div class="col-md-12">
              <div class="image-center-nobooking" style="text-align: center;margin-top: 5px;margin-bottom: 120px;">
                                      ...
                                      <div class="container">
                                          <div class="search">
                                              <div class="form-group has-search">
                                                  ...
                                                  <input type="search" style="width: 430px;" class="form-control "
                                              ...
                                              <div data-filter-item data-filter-name="chemistry">
                                                  <div class="container-fluid ">
                                                      <div class="row mt-2 row-rap">
                                                          ...
                                                          <div class="col-md-6">
                                                              <p style="float: right;">
                                                                  <a href="./test.html"> <button class="schedule-btn"
                                                                          style="width: 80px;height: 43px;">
                                                                          Add
                                                                      </button>
                                                                  </a>
