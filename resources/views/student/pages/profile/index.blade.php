                                ...
                                <div class="tab-pane fade chee" id="v-pills-Education" role="tabpanel"
                                    ...
                                    <form action="{{route('student.education.update')}}" method="Post" enctype="multipart/form-data" id="studentEducationForm" >
                                        ...
                                        <!-- <div class="row mt-3">
                                            ...
                                            <div class="input-text col-md-4">
                                                <select name="major[]" class="form-select form-select-lg mb-3 w-100">
                                            ...
                                            <div class="input-text col-md-4">
                                                <select name="student_level" class="form-select form-select-lg mb-3 w-100"
                                                    id="levels">
                                        ...
                                        <div class="row mt-3">
                                            <div class="input-text col-md-6">
                                                <select name="institute[]" class="form-select form-select-lg mb-3 w-100"
                                                    aria-label=".form-select-lg example">
