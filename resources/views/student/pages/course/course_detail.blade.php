                                                ...
                                                <div class="row mt-3 mb-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12 ">
                                                                <button class="schedule-btn w-100 mt-4" data-toggle="modal" data-target="#payModel">Buy Now</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="text-center">
                                                ...
                                                <span class="round">
                                                <input id="checkbox1" name="paytype" onclick="paymentMethod(this.value)" class="radio-custom" value="paypal" type="radio">
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="text-center">
                                                ...
                                                <span class="round">
                                                <input id="checkbox2" name="paytype" onclick="paymentMethod(this.value)" value="skrill" type="radio">
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="text-center">
                                                ...
                                                <span class="round">
                                                <input id="checkbox3" name="paytype" onclick="paymentMethod(this.value)"  value="wallet" type="radio">
                                                </span>
                                            </div>
                                        </div>
                                    </div>
