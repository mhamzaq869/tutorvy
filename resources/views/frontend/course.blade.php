                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <img src="{{asset('assets/images/ico/Square-white.jpg')}}" class="border-round course_thumb" alt="Avatar" >
                                @else
                                    <img src="{{$course->thumbnail}}" class="border-round course_thumb" alt="Avatar" >
