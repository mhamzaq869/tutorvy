        ...
        function() {
            ...
            function decoratePencil() {
                ...
                var colors = [
                    ...
                    image = new Image;
                image.onload = function() { context.drawImage(image, 4, 4, 32, 32), bindEvent(context, "Pencil") }, image.src = data_uris.pencil;
            ...
            function decorateLineWidth() {
                var context = getContext("line-width"),
                    image = new Image;
                image.onload = function() { context.drawImage(image, 4, 4, 32, 32) }, image.src = data_uris.lineWidth;
            ...
            function decorateColors() {
                var context = getContext("colors"),
                    image = new Image;
                image.onload = function() { context.drawImage(image, 4, 4, 32, 32) }, image.src = data_uris.colorsPicker;
            ...
            function decorateAdditionalOptions() {
                var context = getContext("additional"),
                    image = new Image;
                image.onload = function() { context.drawImage(image, 4, 4, 32, 32) }, image.src = data_uris.extraOptions;
                var additionalContainer = find("additional-container"),
